...
class VideoSource : public QObject
{
    Q_OBJECT
public:
    VideoSource(QSettings &config, QObject *parent = 0);
    VideoSource(ParamtersForIPCamera param, QObject *parent = 0);
    ~VideoSource();
    //共有函数
    bool starCaptureVideo(void);
    void stopCaptureVideo(void);
    bool isCaptureVideoStart(void);
...
private:
    ...
    ParamtersForIPCamera camera_param_;
